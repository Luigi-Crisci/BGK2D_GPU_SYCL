...
namespace bgk{
    void outdat(storage& bgk_storage, const int itfin,const int itstart,const int ivtim,const int isignal,const int itsave,const int icheck){
      ...
      file_manager.write(16, "Reynolds     =",0.5*bgk_storage.u0*bgk_storage.l/bgk_storage.svisc+0.5*bgk_storage.u00*bgk_storage.l/bgk_storage.svisc, "\n");
      ...
      file_manager.write(16, " ", "\n");
        ...
        std::cout << "Reynolds     = " << 0.5 * bgk_storage.u0 * bgk_storage.l / bgk_storage.svisc + 0.5 * bgk_storage.u00 * bgk_storage.l / bgk_storage.svisc << "\n";
    ...
    if(bgk_storage.myrank == 0) then
         std::cout << "DEBUG1: Exiting from sub. outdat\n";
      endif
#endif    
    }
}